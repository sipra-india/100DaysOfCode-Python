...
print("You are at the crossroads. Where do you want to go, left or right?")
choice1 = input("Type 'left' or 'right' to continue: ").lower()
if choice1 == "left":
  ...
  if choice2 == "wait":
    ...
    choice3 = input("Type 'red', 'yellow' or 'blue' to continue: ").lower()
    if choice3 == 'yellow':
